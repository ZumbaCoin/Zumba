...
Zumba Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Zumba Core, where everyone uses
...
pay attention to for reviewers of Zumba Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Zumba Core uses tinyformat, which is type safe. Leave them out to avoid confusion
