...
This mechanism has been integrated into Bitcore-Node-Zumba which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/zumbacoin/insight-api-zumba#web-socket-api](https://github.com/zumbacoin/insight-api-zumba#web-socket-api) 
* API: [https://github.com/zumbacoin/insight-api-zumba#instantsend-transactions](https://github.com/zumbacoin/insight-api-zumba#instantsend-transactions) 
...
By default, the Zumba Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Zumba Core daemon:
