...
Only requiring some minor changes is zumba.cpp.
...
Changes to zumba.cpp
----------------------
zumba.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
