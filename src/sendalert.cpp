...
2. run zumbad with -printalert or -sendalert like this:
   /path/to/zumbad -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.zumba.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Zumba Core:0.12.0.58/"));
