 ...
 *
 *   // network
 *   CZumbaNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.zumba.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CZumbaNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: ZumbaNetwork
// //   -- signature requirements : Key1(User)
// class CZumbaNetworkVariable : public CGovernanceObject
// {
// private:
