...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ZumbaNetwork") type = ZumbaNetwork;
    if(strType == "ZumbaNetworkVariable") type = ZumbaNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ZumbaNetwork) s = "ZumbaNetwork";
    if(type == ZumbaNetworkVariable) s = "ZumbaNetworkVariable";
