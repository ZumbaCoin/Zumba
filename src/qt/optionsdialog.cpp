    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ZUMBA-light"), QVariant("light"));
    ui->theme->addItem(QString("ZUMBA-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ZUMBA-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ZUMBA-traditional"), QVariant("trad"));
