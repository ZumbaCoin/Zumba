    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Zumba Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Zumba address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zumba: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Zumba Core"), this);
    aboutAction->setStatusTip(tr("Show information about Zumba Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Zumba Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Zumba addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Zumba addresses"));
    ...
    openAction->setStatusTip(tr("Open a zumba: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Zumba Core help message to get a list with possible Zumba Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Zumba Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Zumba network", "", count));
}
...
{
    QString strTitle = tr("Zumba Core"); // default title
