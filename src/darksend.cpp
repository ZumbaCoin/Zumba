...
{
    if(fLiteMode) return; // ignore all Zumba related functionality
...
/*
    ...
    allow endless transaction that would bloat Zumba and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("zumba-privatesend");
